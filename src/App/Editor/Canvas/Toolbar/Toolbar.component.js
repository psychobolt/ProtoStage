  ...
  <x-box style={styles.container} vertical>
    <x-box>
      <x-box style={styles.inputContainer} vertical>
        <x-label><strong>Layers</strong></x-label>
        <x-box>
      ...
      <x-box style={styles.inputContainer} vertical>
        <x-label><strong>Sync New Paths</strong></x-label>
        <x-box style={styles.checkboxContainer}>
          ...
          />
          <x-label for="sync_new_paths">On Scene</x-label>
        </x-box>
      </x-box>
    </x-box>
    ...
    <x-box>
      <x-box style={styles.inputContainer} vertical>
        <x-label><strong>Grid Spacing</strong></x-label>
        <XNumberInput
          value={gridSpacing}
          min={1}
          suffix=" px"
